#!/usr/bin/env python3
"""Multi-round benchmark: run N rounds and collect per-round details."""
...
# Summary table
print(f"\n{'='*80}")
print(f"Qwen3.6-27B Baseline | {CTX//1000}K context | {N} concurrent | {ROUNDS} rounds")
print(f"{'='*80}")
...
# Save JSON
outfile = f"/tmp/bench_multiround_{N}c_{CTX//1000}k.json"
with open(outfile, "w") as f:
    json.dump({"config": {"api": "openai", "concurrency": N, "context": CTX, "output": OUTPUT, "rounds": ROUNDS},
               "rounds": all_rounds,
